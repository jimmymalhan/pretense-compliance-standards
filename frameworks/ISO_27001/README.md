# ISO_27001 — synthetic compliance corpus
...
#   pretense scan frameworks/ISO_27001/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework ISO_27001
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m iso_27001 -q --noconftest
```
