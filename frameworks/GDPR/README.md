# GDPR — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**228 synthetic cases** across **19 data kinds** that the **GDPR** framework regulates.
...
#   pretense scan frameworks/GDPR/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework GDPR
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m gdpr -q --noconftest
```
