# DPDP — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**141 synthetic cases** across **12 data kinds** that the **DPDP** framework regulates.
...
#   pretense scan frameworks/DPDP/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework DPDP
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m dpdp -q --noconftest
```
