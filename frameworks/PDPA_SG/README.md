# PDPA_SG — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**141 synthetic cases** across **12 data kinds** that the **PDPA_SG** framework regulates.
...
#   pretense scan frameworks/PDPA_SG/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework PDPA_SG
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m pdpa_sg -q --noconftest
```
