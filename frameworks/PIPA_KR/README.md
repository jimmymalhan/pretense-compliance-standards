# PIPA_KR — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**141 synthetic cases** across **12 data kinds** that the **PIPA_KR** framework regulates.
...
#   pretense scan frameworks/PIPA_KR/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework PIPA_KR
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m pipa_kr -q --noconftest
```
