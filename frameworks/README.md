...
|-----------|------:|--------------|-----------|
| [`SOC2`](SOC2/README.md) | 247 | `run.mjs --framework SOC2` | `pytest -m soc2` |
| [`ISO_27001`](ISO_27001/README.md) | 338 | `run.mjs --framework ISO_27001` | `pytest -m iso_27001` |
| [`ISO_27701`](ISO_27701/README.md) | 388 | `run.mjs --framework ISO_27701` | `pytest -m iso_27701` |
| [`NIST_800_53`](NIST_800_53/README.md) | 286 | `run.mjs --framework NIST_800_53` | `pytest -m nist_800_53` |
| [`NIST_800_171`](NIST_800_171/README.md) | 259 | `run.mjs --framework NIST_800_171` | `pytest -m nist_800_171` |
| [`FedRAMP`](FedRAMP/README.md) | 247 | `run.mjs --framework FedRAMP` | `pytest -m fedramp` |
| [`FISMA`](FISMA/README.md) | 311 | `run.mjs --framework FISMA` | `pytest -m fisma` |
| [`NIS2`](NIS2/README.md) | 247 | `run.mjs --framework NIS2` | `pytest -m nis2` |
| [`NYDFS_500`](NYDFS_500/README.md) | 267 | `run.mjs --framework NYDFS_500` | `pytest -m nydfs_500` |
| [`DORA`](DORA/README.md) | 314 | `run.mjs --framework DORA` | `pytest -m dora` |
| [`APRA_CPS234`](APRA_CPS234/README.md) | 269 | `run.mjs --framework APRA_CPS234` | `pytest -m apra_cps234` |
...
| [`HITRUST`](HITRUST/README.md) | 306 | `run.mjs --framework HITRUST` | `pytest -m hitrust` |
| [`GDPR`](GDPR/README.md) | 228 | `run.mjs --framework GDPR` | `pytest -m gdpr` |
| [`UK_GDPR`](UK_GDPR/README.md) | 228 | `run.mjs --framework UK_GDPR` | `pytest -m uk_gdpr` |
...
| [`FADP`](FADP/README.md) | 188 | `run.mjs --framework FADP` | `pytest -m fadp` |
...
| [`SOX`](SOX/README.md) | 247 | `run.mjs --framework SOX` | `pytest -m sox` |
| [`GLBA`](GLBA/README.md) | 136 | `run.mjs --framework GLBA` | `pytest -m glba` |
