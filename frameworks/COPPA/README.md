# COPPA — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**65 synthetic cases** across **5 data kinds** that the **COPPA** framework regulates.
...
#   pretense scan frameworks/COPPA/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework COPPA
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m coppa -q --noconftest
```
