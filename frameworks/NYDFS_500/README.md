# NYDFS_500 — synthetic compliance corpus
...
#   pretense scan frameworks/NYDFS_500/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework NYDFS_500
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m nydfs_500 -q --noconftest
```
