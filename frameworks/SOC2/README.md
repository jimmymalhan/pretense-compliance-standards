# SOC2 — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**257 synthetic cases** across **23 data kinds** that the **SOC2** framework regulates.
...
#   pretense scan frameworks/SOC2/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework SOC2
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m soc2 -q --noconftest
```
