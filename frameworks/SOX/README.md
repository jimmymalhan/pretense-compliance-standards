# SOX — synthetic compliance corpus

> SYNTHETIC — FAKE COMPLIANCE TEST DATA, NOT REAL

**257 synthetic cases** across **23 data kinds** that the **SOX** framework regulates.
...
#   pretense scan frameworks/SOX/
# … or drive the synthetic corpus through the bridge:
node --experimental-transform-types \
  pretense_compliance_standards/pretense_bridge/run.mjs --framework SOX
```

## Run this framework's tests

```bash
uv run pytest tests/test_pcs.py -m sox -q --noconftest
```
